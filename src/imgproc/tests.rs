...
mod tests {
    ...
    fn test_blur() {
        ...
        let res = blur(&m, ksize, Point2i::new(-1, -1), BorderTypes::Reflect101
).unwrap();
...
,
    ...
    fn test_gaussian_blur() {
        ...
        let ksize = Size2i::new(3, 3);
        let res = gaussian_blur(&m, ksize, 1.0, 1.0, BorderTypes::Reflect101
).unwrap();
    ...
    fn test_bilateral_filter() {
        ...
        let res = bilateral_filter(&src, 5, 50.0, 50.0, BorderTypes::Reflect101
).unwrap();
    ...
    fn test_sobel() {
        ...
        let _res = sobel(&src, 1, 0, 3, 1.0, 0.0, BorderTypes::Reflect101
).unwrap();
        ...
        let res_f32 = sobel(&src_f32, 1, 0, 3, 1.0, 0.0, BorderTypes::Reflect101
).unwrap();
    ...
    fn test_scharr() {
        ...
        let res = scharr(&src, 1, 0, 1.0, 0.0, BorderTypes::Reflect101
).unwrap();
    ...
    fn test_laplacian() {
        ...
        let res = laplacian(&src, 1, 1.0, 0.0, BorderTypes::Reflect101
).unwrap();
        ...
        let res_peak = laplacian(&src_peak, 1, 1.0, 0.0, BorderTypes::Reflect101
).unwrap();
